...
by sending hex value to Dragon through the driver.
...
Value to send depends on design (USB_IO8 or USB_reg_banks). Don't forget to load design file
*before* loading Linux driver !
